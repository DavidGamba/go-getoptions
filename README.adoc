...
* link:./examples/mygit/log/main.go[]
* link:./examples/mygit/show/main.go[]
* link:./examples/mygit/slow/main.go[]
...
The slow command shows an example of an slow command that can be cancelated with `Ctrl+C`.
...
For an overview of the Directed Acyclic Graph Build System see 
