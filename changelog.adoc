...
But if we want to modifty the line:
Use 'complex help <command>' for extra details.
We could do it there, or we can do it as a compilation string like for i18n
