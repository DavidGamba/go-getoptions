...
== WIP v0.21.0: Breaking Change

=== Support Go version 1.13+

Dropping support for Go 1.10, 1.11 and 1.12.
The `errors.Is` and `errors.As` features greatly simplify error testing and handling and are used in the new DAG build system.
...
Documentation can be found in its own link::github.com/DavidGamba/go-getoptions/dag/README.adoc[README].
